                    ...
                    <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
                        <form action="{{ route('checkout') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="flex flex-start mb-6">
                                <h3 class="text-2xl">Data Pribadi</h3>
                            </div>
                            ...
                            <div class="flex flex-col mb-4">
                                <label for="phone-number" class="text-sm mb-2">Nomer Telephone</label>
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="bg-red-600 text-white text-lg font-semibold hover:bg-red-800 hover:text-white focus:outline-none w-full py-3 rounded-full focus:text-black transition-all duration-200 px-6">
                                    Checkout Now
                                </button>
                            </div>
                        </form>
