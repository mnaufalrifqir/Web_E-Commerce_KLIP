    ...
    <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
            <div class="w-full md:hidden px-4">
                ...
                <span class="text-3xl text-red-600 mt-3">IDR {{ number_format($product->price) }}</span>
            </div>
            <div class="flex-1">
                <div class="slider">
                    <div class="thumbnail">
            ...
            <div class="flex-1 px-4 md:p-6">
                <h2 class="text-5xl font-semibold">{{ $product->name }}</h2>
                <p class="text-3xl text-red-600 mt-4 font-bold my-6">IDR {{ number_format($product->price) }}</p>
