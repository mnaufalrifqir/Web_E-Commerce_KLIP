...
@section('content')
    ...
    <section class="flex items-center hero">
        <div class="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
            <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
                Seragam Telkom<br class="" />Murah dan Terpercaya
            </h1>
            <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
                Kami menyediakan Seragam nyaman dipakai yang
                <br class="hidden lg:block" />membuat badan terasa nyaman
            </h2>
            <div>
                <a href="#browse-the-room"
                    class="bg-red-400 text-white hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Explore
                    Now</a>
            </div>
        </div>
        <div class="w-full inset-0 md:relative md:w-1/2">
            <div class="relative hero-image">
                ...
                <img src="/frontend/images/content/header.png" alt="hero 1"
    ...
    <section class="">
        <div class="flex ml-16">
            <!-- Text -->
            <div>
                <h1 class="ml-16 mt-48 text-3xl font-bold">About Klip</h1>
                <p class="ml-16 mt-4 mr-56   text-gray-500 max-w-xl text-justify">
                    Klip adalah aplikasi penjualan baju dan aksesoris telkom, terdapat berbagai macam produk yang bisa
                    dibeli, anda bisa membeli secara online
                    jadi anda tidak perlu mencari lewat cp atau mencari orang yang berjualan. Cukup dengan menggunakan
                    website klip anda bisa memilih, memesan, dan
                    menentukan ukuran
                </p>
            </div>
            ...
            <div class="mt-32 mr-20">
                <img src="/frontend/images/content/about.jpg" class="object-cover h-80 w-auto rounded-xl ">
            </div>
